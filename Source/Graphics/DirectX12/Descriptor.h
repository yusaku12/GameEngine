...
namespace Engine
{
	...
	public:
		 ...
		 */
		[[nodiscard]] std::optional<DX12DescriptorAllocation> allocate();
		 ...
		 */
		[[nodiscard]] std::uint32_t getAllocatedCount() const noexcept { return m_nextIndex; }
		 ...
		 */
		[[nodiscard]] ID3D12DescriptorHeap* get() const noexcept { return m_heap.Get(); }
