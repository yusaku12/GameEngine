...
namespace Engine
{
    ...
    public:
         ...
         */
        ID3D12Device* get() const noexcept { return m_device.Get(); }
         ...
         */
        IDXGIAdapter4* getAdapter() const noexcept { return m_adapter.Get(); }

        /**
         * @brief 取得済みのデバイス機能を取得する
         * @return デバイス機能
         */
        const DX12DeviceCapabilities& getCapabilities() const noexcept { return m_capabilities; }
    ...
    private:
         ...
         * @param enableGpuBasedValidation GPU-based validation を有効にするか
         * @return 成功した場合は true
         */
        bool enableDebugLayer(bool enableGpuBasedValidation);

        /**
         * @brief DXGI Debug の Live Object Report を有効にする
         */
        void enableDxgiDebug();

        /**
         * @brief DXGI Factory を作成する
         * @return 成功した場合は true
         */
        bool selectAdapter();

        /**
         * @brief DirectX 12 デバイスを作成する
         * @return 成功した場合は true
         */
        bool createDevice();
