...
& $Flatc --cpp -o $output -I $schema (Join-Path $schema 'Common.fbs') (Join-Path $schema 'Material.fbs') (Join-Path $schema 'Model.fbs') (Join-Path $schema 'Prefab.fbs') (Join-Path $schema 'Scene.fbs')
